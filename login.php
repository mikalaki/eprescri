        ...
        <ul>
          ...
          <li class="drop-down"><a href="">Log in</a>
            <ul>
              ...
              <li><a  id="doctor" href="login.php">Log in as Doctor</a></li>
              <li><a  id="pharmacy"href="login.php">Log in as Pharmacy</a></li>
              <li><a  id="patient" href="login.php">Log in as Patient</a></li>
              <li><a  id="company" href="login.php">Log in as Company</a></li>
            </ul>
          </li>
