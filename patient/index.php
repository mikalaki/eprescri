...
<head>
  ...
  <title>Patient's eprescri application</title>
...
if (!isset($_SESSION['loggedin']) || $_SESSION['usertype']!='patient') {
  ...
  <section id="doc-area" >
    <div class="container">
      ...
      <div class="row">
         ...
         <!-- Patient's main Content -->
        <div class="col-md ">
          <div class="alert alert-primary" role="alert">
            Bellow is a list of all your prescriptions.
