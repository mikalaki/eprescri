  ...
  <main id="main">
    ...
    <?php
      if (!isset($_SESSION['loggedin']) ) {
        require("login_as.php");
      }
      else{
        echo "<div class=\"section-title\">
                <h2 class=\"noncapitalize-h2-title\">Logged in as ".$_SESSION['usertype']."</h2>
                <a href=".$_SESSION['usertype'] . " ><h4>Go to Application  <i class=\"fas fa-sign-in-alt\"></i> </h4> </a>
              </div>";
      }
