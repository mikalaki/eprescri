      ...
      <div class="row">
        ...
        <div class="col-sm-9 doc-area-main">
          <div class="alert alert-danger" role="alert">
            <h4><i class="fas fa-exclamation-triangle"></i> Are you sure you want to delete the prescription with ID= <?php echo $_GET['ID'];?>? </h4>
          </div>

            <a href="deleteprescription.php?ID=<?php echo $_GET['ID'];?>" ><button type="button" class="btn btn-outline-danger">Yes, delete it!</button></a>
            <a href="prescriptions.php"><button type="button" class="btn btn-outline-dark">No, go back.</button></a>
