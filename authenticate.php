...
if( $_POST["usertype"]== 'doctor'){
  $query = 'SELECT username, password FROM user_doctor WHERE username = ?';
}
else if( $_POST["usertype"] == 'pharmacy'){
  $query = 'SELECT username, password FROM user_pharmacy WHERE username = ?';
}
else if( $_POST["usertype"] == 'patient'){
  $query = 'SELECT username, password FROM user_patient WHERE username = ?';
}
else if( $_POST["usertype"] == 'company'){
  $query =  'SELECT username, password FROM user_company WHERE username = ?';
}
